...
export default {
  ...
  data() {
    return {
      editing: false,
      level: [
        { name: "小萌新~", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_0.svg' },
        { name: "小魔仙", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_1.svg' },
        { name: "初露头角", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_2.svg' },
        { name: "大水笔", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_3.svg' },
        { name: "后宫团", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_4.svg' },
        { name: "有豪宅", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_5.svg' },
        { name: "德国骨科", icon: 'https://cdn.jsdelivr.net/gh/LIlGG/cdn@1.0.0/img/Sakura/images/level/level_6.svg' },
      ],
      globalData: globals,
    };
  },
